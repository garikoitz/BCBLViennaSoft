...
bvRP = '/Users/glerma/toolboxes/BCBLViennaSoft';
imagesDir = fullfile(bvRP,'morphing','DATA','retWordsMagno');
...
expnum      = 103;
runnum      = 2; 
pathMasks = fullfile(imagesDir, 'maskimages.mat');
...
log_dir = '/Users/glerma/toolboxes/BCBLViennaSoft/measurementlaptop/logfiles';
filename = sprintf('%s_subj%s_run%i_exp%i.mat',gettimestring,subID,runnum,expnum);
log_file = fullfile(log_dir,filename)
Screen('Preference', 'SkipSyncTests', 1);
[images,maskimages] = ...
  showmulticlass(log_file, offset,movieflip,frameduration,fixationinfo,...
                 fixationsize,tfun, ...
